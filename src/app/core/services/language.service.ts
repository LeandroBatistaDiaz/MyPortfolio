...
const ENGLISH: Record<string, string> = {
  ...
  'Licenciatura en Inform\u00e1tica': "Bachelor's Degree in Computer Science", 'Aprendizaje continuo': 'Continuous learning', 'Certificaciones seleccionadas': 'Selected certifications', Certificado: 'Certificate',
  ...
  'Computer Vision para reconocimiento de productos': 'Computer Vision for product recognition', 'Computer Vision': 'Computer Vision', 'Computer Vision · Retail Automation': 'Computer Vision · Retail Automation',
